...
export class CashflowContractControllerBase {
  constructor(
  ...
  @swagger.ApiCreatedResponse({ type: CashflowContract })
  @swagger.ApiForbiddenResponse({ type: errors.ForbiddenException })
  async create(
    @common.Body() data: CashflowContractCreateInput,
  ...
  @swagger.ApiOkResponse({ type: [CashflowContract] })
  ...
  async findMany(
    ...
    const args = plainToClass(CashflowContractFindManyArgs, request.query);
    ...
    if (invalidAttributes.length) {
      ...
      throw new common.ForbiddenException(
        `Updating the relationship: ${
          invalidAttributes[0]
        } of ${"CashflowContract"} is forbidden for roles: ${roles}`
      );
    }
