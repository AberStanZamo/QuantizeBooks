...
@InputType()
class CashflowContractUpdateInput {
  @ApiProperty({
    required: false,
  ...
  @ApiProperty({
    required: false,
    type: () => CashflowContractUpdateManyWithoutCashflowContractsInput,
  })
  @ValidateNested()
  @Type(() => CashflowContractUpdateManyWithoutCashflowContractsInput)
  @IsOptional()
  @Field(() => CashflowContractUpdateManyWithoutCashflowContractsInput, {
    nullable: true,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => UserUpdateManyWithoutCashflowContractsInput,
  })
  @ValidateNested()
  @Type(() => UserUpdateManyWithoutCashflowContractsInput)
  @IsOptional()
  @Field(() => UserUpdateManyWithoutCashflowContractsInput, {
    nullable: true,
  })
  users?: UserUpdateManyWithoutCashflowContractsInput;
}
export { CashflowContractUpdateInput };
